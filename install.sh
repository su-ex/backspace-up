...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/backspace-up.py https://raw.githubusercontent.com/su-ex/backspace-up/master/backspace-up.py
